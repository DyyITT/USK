                    ...
                    <td>
                        @if (Auth::user()->role == 'admin')
                            <button class="btn btn-success"
                                data-toggle="modal"data-target="#EditSoal{{ $s->idsoal }}">Edit</button>



                            <button class="btn btn-danger"
                                data-toggle="modal"data-target="#DelSoal{{ $s->idsoal }}">Delete</button>

                            |
                        @endif
                        @if (Auth::user()->role == 'user')
                            <button class="btn btn-info"
                                data-toggle="modal"data-target="#WorkSoal{{ $s->idsoal }}">Kerjakan</button>
                        @endif
                    </td>
                </tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/soal/storeupdate" method="post"class="form-floating">
                                    ...
                                    @csrf
                                    <input type="hidden" name="idsoal" id="kode"readonly
                                        class="form-control"value="{{ $s->idsoal }}">
                                    <div class="form-floating">
                                        <label for="floatingInputValue">JudulMateri</label>

                                        <input type="text" name="judulmateri"required="required"
                                            class="form-control"value="{{ $s->judulmateri }}">
                                    ...
                                    <div class="form-floating">
                                        <label for="floatingInputValue">Tenggal Waktu</label>

                                        <input type="date" name="bataswaktu"required="required"
                                            class="form-control"value="{{ $s->bataswaktu }}">
